...
(async function() {
  ...
  await Promise.all([
    execCommand(`${crossEnv} BAASIRAN_BUILD=browser ${gulp} compile`),
    execCommand(`${crossEnv} BAASIRAN_BUILD=weapp ${gulp} compile`),
    execCommand(`${crossEnv} BAASIRAN_BUILD=node ${gulp} compile`),
    execCommand(`${crossEnv} BAASIRAN_BUILD=react-native ${gulp} compile`),
  ]);
