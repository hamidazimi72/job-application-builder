...
jest.dontMock('../src/core/ParseQuery');
jest.dontMock('../src/core/LiveQuerySubscription');
...
const LiveQueryClient = require('../src/core/LiveQueryClient').default;
const ParseObject = require('../src/core/ParseObject').default;
const ParseQuery = require('../src/core/ParseQuery').default;
const WebSocketController = require('../src/core/WebSocketController');
const { resolvingPromise } = require('../src/core/promiseUtils');
