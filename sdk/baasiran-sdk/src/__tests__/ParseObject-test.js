jest.dontMock('../src/core/arrayContainsObject');
jest.dontMock('../src/core/canBeSerialized');
jest.dontMock('../src/core/CoreManager');
jest.dontMock('../src/core/promiseUtils');
jest.dontMock('../src/core/decode');
jest.dontMock('../src/core/encode');
jest.dontMock('../src/core/equals');
jest.dontMock('../src/core/escape');
jest.dontMock('../src/core/ObjectStateMutations');
jest.dontMock('../src/core/parseDate');
jest.dontMock('../src/core/ParseError');
jest.dontMock('../src/core/ParseFile');
jest.dontMock('../src/core/ParseGeoPoint');
jest.dontMock('../src/core/ParseObject');
jest.dontMock('../src/core/ParseOp');
jest.dontMock('../src/core/ParsePolygon');
jest.dontMock('../src/core/ParseRelation');
jest.dontMock('../src/core/RESTController');
jest.dontMock('../src/core/SingleInstanceStateController');
jest.dontMock('../src/core/TaskQueue');
jest.dontMock('../src/core/unique');
jest.dontMock('../src/core/UniqueInstanceStateController');
jest.dontMock('../src/core/unsavedChildren');
jest.dontMock('../src/core/ParseACL');
...
jest.setMock('../src/core/ParseRelation', mockRelation);
...
jest.setMock('../src/core/ParseQuery', mockQuery);

import { DEFAULT_PIN, PIN_PREFIX } from '../src/core/LocalDatastoreUtils';
...
jest.setMock('../src/core/LocalDatastore', mockLocalDatastore);

const CoreManager = require('../src/core/CoreManager');
const EventuallyQueue = require('../src/core/EventuallyQueue');
const ParseACL = require('../src/core/ParseACL').default;
const ParseError = require('../src/core/ParseError').default;
const ParseFile = require('../src/core/ParseFile').default;
const ParseGeoPoint = require('../src/core/ParseGeoPoint').default;
const ParsePolygon = require('../src/core/ParsePolygon').default;
const ParseObject = require('../src/core/ParseObject').default;
const ParseOp = require('../src/core/ParseOp');
const RESTController = require('../src/core/RESTController');
const SingleInstanceStateController = require('../src/core/SingleInstanceStateController');
const unsavedChildren = require('../src/core/unsavedChildren').default;
...
jest.spyOn(CoreManager, 'getParseUser').mockImplementation(() => require('../src/core/ParseUser').default);

const { SetOp, UnsetOp, IncrementOp } = require('../src/core/ParseOp');
