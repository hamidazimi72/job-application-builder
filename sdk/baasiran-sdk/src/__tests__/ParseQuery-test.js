...
import { DEFAULT_PIN } from '../src/core/LocalDatastoreUtils';
...
describe('ParseQuery', () => {
  ...
  it('overrides cached object with query results', done => {
    ...
    jest.resetModules();
    ParseObject = require('../src/core/ParseObject').default;
    CoreManager = require('../src/core/CoreManager');
    ParseQuery = require('../src/core/ParseQuery').default;
