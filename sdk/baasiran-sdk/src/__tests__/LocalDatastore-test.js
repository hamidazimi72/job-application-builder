...
jest.autoMockOff();
jest.unmock('../src/core/LocalDatastoreUtils');
jest.dontMock('../src/core/ParseOp');
require('../src/core/ParseOp');
const encode = require('../src/core/encode').default;
...
jest.setMock('../src/core/ParseObject', MockObject);

const mockQueryFind = jest.fn();
jest.mock('../src/core/ParseQuery', () => {
...
const LocalDatastore = require('../src/core/LocalDatastore');
const ParseObject = require('../src/core/ParseObject');
const ParseQuery = require('../src/core/ParseQuery');
const ParseUser = require('../src/core/ParseUser').default;
const LocalDatastoreController = require('../src/core/LocalDatastoreController');
const RNDatastoreController = require('../src/core/LocalDatastoreController.react-native');
const BrowserStorageController = require('../src/core/StorageController.browser');
const DefaultStorageController = require('../src/core/StorageController.default');
// Register our mocks
jest.spyOn(CoreManager, 'getParseObject').mockImplementation(() => require('../src/core/ParseObject'));
jest.spyOn(CoreManager, 'getParseQuery').mockImplementation(() => require('../src/core/ParseQuery'));
...
import {
  ...
  OBJECT_PREFIX,
  isLocalDatastoreKey,
} from '../src/core/LocalDatastoreUtils';
